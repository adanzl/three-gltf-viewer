...
THREEx.RendererStats = function () {
    ...
    for (var i = 0; i < nLines; i++) {
        ...
        msTexts[i].style.cssText = 'color:#f00;background-color:#311;font-family:Helvetica,Arial,sans-serif;font-size:11px;font-weight:bold;line-height:15px';
    ...
    return {
        ...
        update: function (webGLRenderer) {
            ...
            // refresh only 24 time per second
            if (Date.now() - lastTime < 1000 / 24) return;
            lastTime = Date.now()
